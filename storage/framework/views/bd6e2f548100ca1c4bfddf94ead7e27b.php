<li class="nav-item dropdown" id="notification-bell">
    ...
    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="max-height: 400px; overflow-y: auto;">
        ...
        <a href="<?php echo e(route('admin.notifications.index')); ?>" class="dropdown-item dropdown-footer">View All Notifications</a>
    </div>
</li>
...
function loadNotifications() {
    fetch('<?php echo e(route('admin.notifications.unread')); ?>')
...
function clearAllNotifications(event) {
    ...
    if (confirm('Clear all notifications?')) {
        fetch('<?php echo e(route('admin.notifications.clear-all')); ?>', {
            method: 'DELETE',
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                'Content-Type': 'application/json',
...
<?php $__env->stopPush(); ?><?php /**PATH D:\eagle2\resources\views/layouts/partials/navbar-notification-bell.blade.php ENDPATH**/ ?>