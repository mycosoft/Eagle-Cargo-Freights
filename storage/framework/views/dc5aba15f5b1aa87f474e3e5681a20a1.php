    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="<?php echo e(route('admin.expenses.index')); ?>" class="btn btn-sm btn-secondary">
...
unset($__errorArgs, $__bag); ?>" required>
                                <option value="UGX" <?php echo e(old('currency', 'UGX') == 'UGX' ? 'selected' : ''); ?>>UGX</option>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" id="expense_date" name="expense_date" class="form-control <?php $__errorArgs = ['expense_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('reference_number')); ?>" placeholder="Receipt #, Check #, etc.">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="file" id="receipt_image" name="receipt_image" class="form-control-file <?php $__errorArgs = ['receipt_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                              rows="2" placeholder="Additional notes..."><?php echo e(old('notes')); ?></textarea>
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\eagle2\resources\views/expenses/create.blade.php ENDPATH**/ ?>