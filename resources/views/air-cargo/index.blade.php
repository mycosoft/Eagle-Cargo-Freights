...
@section('title', 'Air Cargo Shipments')

@section('content_header')
    <div class="row">
        <div class="col-sm-6">
            <h1><i class="fas fa-plane"></i> Air Cargo Shipments</h1>
        </div>
        <div class="col-sm-6">
            @can('create air cargo')
            <a href="{{ route('admin.air-cargo.create') }}" class="btn btn-primary float-right">
                <i class="fas fa-plus"></i> Create Air Shipment
            </a>
            @endcan
        </div>
    </div>
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Air Shipments List</h3>
        </div>
        <div class="card-body">
            <!-- Filters -->
            <form action="{{ route('admin.air-cargo.index') }}" method="GET" class="mb-3">
                <div class="row">
                    <div class="col-md-5">
                    ...
                    <tbody>
                        @forelse($shipments as $shipment)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.air-cargo.show', $shipment) }}" class="btn btn-sm btn-info" title="View">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    @can('edit air cargo')
                                    <a href="{{ route('admin.air-cargo.edit', $shipment) }}" class="btn btn-sm btn-warning" title="Edit">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center">No air cargo shipments found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
