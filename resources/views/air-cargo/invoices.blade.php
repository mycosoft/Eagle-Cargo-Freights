...
@section('title', 'Air Cargo Invoices')

@section('content_header')
    <div class="row">
        <div class="col-sm-6">
            <h1><i class="fas fa-file-invoice mr-2"></i>Air Cargo Invoices</h1>
        </div>
        <div class="col-sm-6">
            <a href="{{ route('admin.air-cargo.dashboard') }}" class="btn btn-info float-right"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
        </div>
    </div>
@stop
                ...
                <tbody>
                    @forelse($invoices as $inv)
                        <tr>
                            ...
                            <td><a href="{{ route('admin.air-cargo.show', $inv->shipment) }}">{{ $inv->shipment->tracking_number ?? 'N/A' }}</a></td>
